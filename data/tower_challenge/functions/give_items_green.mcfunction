...
item replace entity @p hotbar.5 with minecraft:green_shulker_box 1
item replace entity @p hotbar.6 with minecraft:green_shulker_box 1
item replace entity @p hotbar.7 with minecraft:green_shulker_box 1
